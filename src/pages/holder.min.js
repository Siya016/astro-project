!function(e) {
    if (e.document) {
        ...
        t.querySelectorAll || (t.querySelectorAll = function(n) {
            var r, i = t.createElement("style"), a = [];
        ...
        function(e) {
            ...
            e.atob = e.atob || function(e) {
                ...
                for (; r < e.length; )
                    ...
                    a = a << 6 | n,
                    o += 6,
                    24 === o && (i.push(String.fromCharCode(a >> 16 & 255)),
                    ...
                    r += 1;
                return 12 === o ? (a >>= 4,
                i.push(String.fromCharCode(255 & a))) : 18 === o && (a >>= 2,
                i.push(String.fromCharCode(a >> 8 & 255)),
                i.push(String.fromCharCode(255 & a))),
                i.join("")
            }
        ...
        (function(t) {
            ...
            function i(e, t) {
                ...
                2 === i.length) {
                    ...
                    l.theme && n.instanceOptions.themes.hasOwnProperty(l.theme) && (n.theme = T(n.instanceOptions.themes[l.theme], null)),
            ...
            function a(e) {
                ...
                !v.noFontFallback && "img" === n.nodeName.toLowerCase() && O.setup.supportsCanvas && "svg" === v.renderer && (v = T(v, {
                    renderer: "canvas"
                }))),
                ...
                "image" == t ? (r.auto || (n.style.width = a.width + "px",
                n.style.height = a.height + "px"),
                "html" == v.renderer ? n.style.backgroundColor = s.bg : (o(b),
                "exact" == r.textmode && (n.holderData.resizeUpdate = !0,
                O.vars.resizableImages.push(n),
                h(n)))) : "background" == t && "html" != v.renderer ? o(b) : "fluid" == t && (n.holderData.resizeUpdate = !0,
                "%" == a.height.slice(-1) ? n.style.height = a.height : null != r.auto && r.auto || (n.style.height = a.height + "px"),
                "%" == a.width.slice(-1) ? n.style.width = a.width : null != r.auto && r.auto || (n.style.width = a.width + "px"),
            ...
            function o(e) {
                ...
                "background" == i ? (a.style.backgroundImage = "url(" + r + ")",
                l.noBackgroundSize || (a.style.backgroundSize = h.width + "px " + h.height + "px")) : ("img" === a.nodeName.toLowerCase() ? x.setAttr(a, {
                    src: r
            ...
            function s(e) {
                ...
                if (m.lineCount > 1) {
                    ...
                    for (var E = 0; E < m.words.length; E++) {
                        ...
                        v = new s.Text(T.text);
                        var k = "\\n" == T.text;
                        !e.noWrap && (x + T.width >= a || k === !0) && (t(g, w, x, g.properties.leading),
                        g.add(w),
                        x = 0,
                ...
                for (var n = 0, r = t.length; r > n; n++) {
                    ...
                    if (i.holderData) {
                        ...
                        if (s) {
                            ...
                            "exact" == a.textmode && (a.exactDimensions = s,
            ...
            function c() {
                O.vars.visibilityCheckStarted || (t.requestAnimationFrame(d),
            ...
            var m = n(2)
              ...
              , j = {
                ...
                run: function(e) {
                    ...
                    -1 === O.setup.renderers.join(",").indexOf(n.renderer) && (n.renderer = O.setup.supportsSVG ? "svg" : O.setup.supportsCanvas ? "canvas" : "html");
            ...
            function() {
                ...
                e.getContext && -1 != e.toDataURL("image/png").indexOf("data:image/png") && (O.setup.renderer = "canvas",
                O.setup.supportsCanvas = !0),
                document.createElementNS && document.createElementNS(F, "svg").createSVGRect && (O.setup.renderer = "svg",
    ...
    , function(e, t) {
        (function(e) {
            ...
            t.parseColor = function(e) {
                var t, n = /(^(?:#?)[0-9a-f]{6}$)|(^(?:#?)[0-9a-f]{3}$)/i, r = /^rgb\((\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*\)$/, i = /^rgba\((\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(0*\.\d{1,}|1)\)$/, a = e.match(n);
                if (null !== a)
                    return t = a[1] || a[2],
                    "#" !== t[0] ? "#" + t : t;
                if (a = e.match(r),
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t) {
            ...
            var S = d.element({
              ...
              , T = o(E);
            /\&amp;(x)?#[0-9A-Fa-f]/.test(T[0]) && (T[0] = T[0].replace(/&amp;#/gm, "&#")),
            T = h + T[0];
            ...
            for (; c < e.length; c++) {
                ...
                if (void 0 !== e[c] && e[c] !== !0)
                    if ("string" == typeof e[c])
                        f && (e[c] = s(e[c])),
                        e[0].children.push(e[c]);
                    else if ("number" == typeof e[c])
                        e[0].children.push(e[c]);
                        ...
                        r(e[c], t, n),
                        e[c][0] && e[0].children.push(e[c][0])
                    } else if ("function" == typeof e[c])
                        u = e[c];
                    else {
                        if ("object" != typeof e[c])
                            throw new TypeError('"' + e[c] + '" is not allowed as a value.');
                        for (h in e[c])
                            e[c].hasOwnProperty(h) && null !== e[c][h] && e[c][h] !== !1 && (e[0].attr[h] = "style" === h && "object" == typeof e[c][h] ? JSON.stringify(e[c][h], a).slice(2, -2).replace(/","/g, ";").replace(/":"/g, ":").replace(/\\"/g, "'") : e[c][h])
                    }
            }
            if (e[0] !== !1) {
                l = "<" + e[0].tag;
    ...
    , function(e, t, n) {
        ...
        e.exports = function() {
            ...
            return function(n) {
                ...
                t.fillRect(0, 0, s, l),
                o.properties.outline && (t.strokeStyle = o.properties.outline.fill,
